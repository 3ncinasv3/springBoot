...
//	public ca.sheridancollege.menegonj.beans.User findUserAccount(String userName) {
//		MapSqlParameterSource namedParameters = new MapSqlParameterSource();
...
//	}
	...
	public boolean validateUserCredentials(String username, String password) {
		...
		try {
			User user = jdbc.queryForObject(query, namedParameters, new BeanPropertyRowMapper<>(User.class));
			// Assuming BCryptPasswordEncoder is used for password encoding
